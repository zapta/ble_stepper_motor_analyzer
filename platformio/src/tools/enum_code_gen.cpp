...
// Gatts status.
static const ListEntry gatts_status_list[] = {ENTRY(ESP_GATT_OK),
    ENTRY(ESP_GATT_INVALID_HANDLE), ENTRY(ESP_GATT_READ_NOT_PERMIT),
    ENTRY(ESP_GATT_WRITE_NOT_PERMIT), ENTRY(ESP_GATT_INVALID_PDU),
    ENTRY(ESP_GATT_INSUF_AUTHENTICATION), ENTRY(ESP_GATT_REQ_NOT_SUPPORTED),
    ENTRY(ESP_GATT_INVALID_OFFSET), ENTRY(ESP_GATT_INSUF_AUTHORIZATION),
    ENTRY(ESP_GATT_PREPARE_Q_FULL), ENTRY(ESP_GATT_NOT_FOUND),
    ENTRY(ESP_GATT_NOT_LONG), ENTRY(ESP_GATT_INSUF_KEY_SIZE),
    ENTRY(ESP_GATT_INVALID_ATTR_LEN), ENTRY(ESP_GATT_ERR_UNLIKELY),
    ENTRY(ESP_GATT_INSUF_ENCRYPTION), ENTRY(ESP_GATT_UNSUPPORT_GRP_TYPE),
    ENTRY(ESP_GATT_INSUF_RESOURCE), ENTRY(ESP_GATT_NO_RESOURCES),
    ENTRY(ESP_GATT_INTERNAL_ERROR), ENTRY(ESP_GATT_WRONG_STATE),
    ENTRY(ESP_GATT_DB_FULL), ENTRY(ESP_GATT_BUSY), ENTRY(ESP_GATT_ERROR),
    ENTRY(ESP_GATT_CMD_STARTED), ENTRY(ESP_GATT_ILLEGAL_PARAMETER),
    ENTRY(ESP_GATT_PENDING), ENTRY(ESP_GATT_AUTH_FAIL), ENTRY(ESP_GATT_MORE),
    ENTRY(ESP_GATT_INVALID_CFG), ENTRY(ESP_GATT_SERVICE_STARTED),
    ENTRY(ESP_GATT_ENCRYPED_MITM), ENTRY(ESP_GATT_ENCRYPED_NO_MITM),
    ENTRY(ESP_GATT_NOT_ENCRYPTED), ENTRY(ESP_GATT_CONGESTED),
    ENTRY(ESP_GATT_DUP_REG), ENTRY(ESP_GATT_ALREADY_OPEN),
    ENTRY(ESP_GATT_CANCEL), ENTRY(ESP_GATT_STACK_RSP), ENTRY(ESP_GATT_APP_RSP),
    ENTRY(ESP_GATT_UNKNOWN_ERROR), ENTRY(ESP_GATT_CCC_CFG_ERR),
    ENTRY(ESP_GATT_PRC_IN_PROGRESS), ENTRY(ESP_GATT_OUT_OF_RANGE)};
